...
- `data/precedents.json` — TB-TCHQ precedents by HS: 3.028 notices / 1.078 codes (legacy import + `data/community/tb-tchq/` merged via `npm run data:merge-community`; audit with `node scripts/audit-community-precedents.mjs`)
